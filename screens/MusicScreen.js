...
import musicActivity from '../assets/logo/musicActivity.jpeg';
...
const MusicScreen = () => {
    ...
    return (
        ...
        navigation.goBack()}}>
            ...
            <Image source={musicActivity} style={styles.img} />
            <LinearGradient style={styles.gradient} colors={[`${Colors.grad1}`, `${Colors.grad2}`]}>
                ...
                <Pressable style={({ pressed }) => [styles.button, pressed && styles.pressed]} onPress={()=>{completeCtx.addComplete(2, 'Listen Music')}}>
